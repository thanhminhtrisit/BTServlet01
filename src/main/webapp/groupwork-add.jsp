			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="job-add" method="post" class="form-horizontal">
								<div class="form-group">
									<label for="name" class="control-label col-sm-2">Job
										Name:</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<label for="start_date" class="control-label col-sm-2">Start
										Date:</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<label for="end_date" class="control-label col-sm-2">End
										Date:</label>
									<div class="col-sm-10">
