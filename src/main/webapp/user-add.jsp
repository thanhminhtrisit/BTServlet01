								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Johnathan Doe"
											class="form-control form-control-line" name="fullname" required="required">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="email" placeholder="johnathan@admin.com"
											...
											id="example-email" required="required">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="password" value="password"
											class="form-control form-control-line" name="password" required="required">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="123 456 7890"
											class="form-control form-control-line" name="phone" required="required">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-12">Select Role</label>
									<div class="col-sm-12">
										<select class="form-control form-control-line" name="role" required="required">
											<c:forEach var="roleitem" items="${roles}">
												<option value="${roleitem.id}">${roleitem.description}</option>
											</c:forEach>
										</select>
									</div>
								</div>
